...
import ForumCategoryPopup from '../../components/elements/ForumCategoryPopup'
import EditForumCategoryPopup from '../../components/elements/EditForumCategoryPopup'
import EditCategoryPopup from "../../components/elements/EditCategoryPopup";
import { Box, Button } from "../../components/elements";
import { LoaderProvider } from "../../context/Preloader";
import { hostedCategoryAxios, hostedForumCategoryAxios } from "../../backendAxios/backendAxios";
...
export default function Category({ icon, text }) {
  ...
  const getAllFazterCategory = async () => {
    setLoading(true);
    const result = await hostedForumCategoryAxios.get("/get-all-categories-admin", {
      headers: authHeader(),
    });
  ...
  const enableDisableCategory = async (id) => {
    await hostedForumCategoryAxios
      .post(`/toggle-category-status/${id}`, {
        headers: authHeader(),
      })
      .then((response) => {
