...
import ForumSubCategoryPopup from "../../components/elements/ForumSubCategoryPopup";
import EditForumSubCategoryPopup from '../../components/elements/EditForumSubCategoryPopup'
...
export default function SubCategory({ icon, text }) {
  ...
  const enableDisableSubCategory = async (id) => {
    await hostedForumCategoryAxios
      .post(`/toggle-subcategory-status/${id}`, {
        headers: authHeader(),
      })
      .then((response) => {
        ...
        {loading ? (
          ...
          <>
            ...
            <ForumSubCategoryPopup
              ...
              title="Add Forum Sub-Category !"
            />

            <EditForumSubCategoryPopup
              updateCategoryId={updateCategoryId}
